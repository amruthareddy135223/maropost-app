...
class TelephonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telephone" do
    assert_difference('Telephone.count') do
      post telephones_url, params: { telephone: { address: @telephone.address, emailid: @telephone.emailid, name: @telephone.name } }
    end
  ...
  test "should update telephone" do
    patch telephone_url(@telephone), params: { telephone: { address: @telephone.address, emailid: @telephone.emailid, name: @telephone.name } }
